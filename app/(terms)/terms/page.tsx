...
const TermsPage = () => {
  return (
    <div className="w-full bg-bg_sub py-20">
      <div className="max-w-[1040px] mx-auto">
        {/* 제목 및 설명 */}
        <div className="flex flex-col items-start gap-3 mb-12 pl-6">
          <h1 className="font-thin text-[32px]">집플 이용약관</h1>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          <h2 className="text-[18px] font-semibold mb-2 text-text_sub2">
            제 1장 (목적)
          </h2>
          <p className="text-[16px] text-text_sub mb-6">
          ...
          <p className="text-[16px] text-text_sub">
