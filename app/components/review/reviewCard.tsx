...
const ReviewCard = ({
  ...
  return (
    <div
      ...
      className="flex flex-row w-full gap-2.5 bg-white border rounded-lg p-6 mx-auto
       shadow-md hover:shadow-md cursor-pointer transition-shadow duration-300 mb-1 border-border"
    >
